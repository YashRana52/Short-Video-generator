...
function ProjectCard({ gen, setGenerations, forCommunity = false }: Props) {
        ...
        >
            ...
            >
              ...
              <div className="flex flex-col items-end w-32 text-sm">
                <ul
                  ...
                  } verflow-hidden right-0 peer-focus:block hover:block w-40 bg-black/50 backdrop-blur text-white border border-gray-500/50 rounded-lg shadow-md mt-2 py-1 z-10`}
                >
                  {gen.generatedImage && (
                    <a
                      href="#"
          ...
          <div className="absolute right-3 bottom-3">
            ...
            <img
              ...
              alt="model"
              className="w-16 h-16 rounded-full object-cover animate-float -ml-8 "
        ...
        <div className="p-4">
          ...
          {gen.productDescription && (
            <div className="mt-3">
              ...
              <div className="p-2 bg-white/3 rounded-md text-sm text-gray-300  ">
                {gen.productDescription}
              </div>
            </div>
          )}
          ...
          {/* user prompt */}
          {gen.userPrompt && (
            <p className="text-xs mt-2 text-gray-400">{gen.userPrompt}</p>
          )}
