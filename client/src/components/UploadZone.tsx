...
function UploadZone({ label, file, onClear, onChange }: uploadZoneProps) {
  return (
    <div className="relative group">
      <div
        className={`relative h-64 rounded-2xl border-2 border-dashed flex flex-col items-center justify-center p-6 transition-all duration-300 ${
          file
      ...
      >
        {file ? (
          <>
            ...
            {/* File Name */}
            <div className="absolute bottom-4 left-4 right-4 bg-black/50 backdrop-blur-md rounded-lg p-3 border border-white/10">
