...
function Results() {
  ...
  return loading ? (
    <div className="h-screen w-full flex items-center justify-center">
      <Loader2 className="animate-spin size-9 text-indigo-400" />
    </div>
  ) : (
        ...
        <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div
                className={`${
                  project?.aspectRatio === "9:16"
                    ? "aspect-9/16"
                    : "aspect-video"
                } sm:max-h-200 rounde-xl bg-gray-900 overflow-hidden relative`}
              >
          ...
          <div className="space-y-6">
              ...
              <div className="flex flex-col gap-3">
                <a href={project.generatedVideo} download>
                  <GhostButton
                    ...
                    className="w-full justify-center rounded-md py-3 disabled:opacity-50 disabled:cursor-not-allowed mt-2"
                  >
                    <Video className="size-4.5" /> Download Video
                  </GhostButton>
                </a>
              </div>
            </div>
            ...
            <div className="glass-panel p-6 rounded-2xl relative overflow-hidden">
              ...
              <h3 className="font-semibold text-xl mb-2">Video Magic</h3>
